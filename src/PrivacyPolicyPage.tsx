...
export const PrivacyPolicyPage: React.FC = () => {
  ...
  const privacySections: PolicySection[] = [
    {
      ...
      content: (
        <>
          <p>
            This Privacy Policy explains how MotoBites Limited
            (&ldquo;MotoRide&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;, or
            &ldquo;our&rdquo;) collects, uses, stores, protects and shares
            personal information when you use the MotoRide Rider App.
          </p>
          <p>
            MotoRide is a technology platform used to coordinate delivery
            services for <strong>MotoBites</strong> and other authorised
            delivery operations.
          </p>
          <p>
            MotoRide may support different categories of delivery partners,
            including motorcycle riders, car drivers, van operators, bicycle
            riders and other approved delivery partners.
          </p>
          <p>
            This Privacy Policy applies to Riders, Delivery Partners and other
            individuals who access or use MotoRide.
          </p>
          <p>
            By using MotoRide, you acknowledge that you have read and understood
            this Privacy Policy.
          </p>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          <p>
            We may collect information necessary to create and operate your
            MotoRide account and facilitate delivery services.
          </p>
          <h3
            style={{
              fontSize: "1.05rem",
    ...
    },
    {
      ...
      content: (
        <>
          <p>
            Where applicable, MotoRide may collect information relating to the
            vehicle used for delivery, including:
          </p>
          ...
          <p>
            This information may be used to verify eligibility and determine
            whether a vehicle is suitable for particular delivery assignments.
          </p>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          <p>
            MotoRide may collect precise or approximate location information
          ...
          <div
            className="document-intro-banner"
          ...
          >
            ...
            <div className="banner-text">
              <strong>Active Delivery Requirement:</strong> MotoRide may require
              location services to be enabled while a Rider is actively
    ...
    },
    {
      ...
      content: (
        <>
          <p>
            When you use MotoRide, we may automatically collect certain
          ...
          <p>
            This information helps us maintain security, troubleshoot problems
            and improve the MotoRide application.
          </p>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          <p>
            MotoRide may collect information relating to your use of the
            platform, including:
          </p>
          <ul className="styled-list">
          ...
          <p>
            This information may be used to operate the delivery service and
    ...
    },
    {
      ...
      content: (
        <>
          <p>
            Where applicable, MotoRide may collect information required to
            process Rider payments and earnings.
          </p>
          <p>This may include:</p>
          <ul className="styled-list">
          ...
          <p>
            Payment information may be processed through authorised payment
            providers.
          </p>
          <p>
            MotoRide may not directly store certain sensitive payment
            information where the relevant service provider processes and stores
    ...
    },
    {
      ...
      content: (
        <>
          <p>
            We may share relevant information with authorised parties where
            necessary to operate MotoRide. These parties may include:
          </p>
          <div className="feature-cards-grid" style={{ marginTop: "1.25rem" }}>
            <div className="feature-card">
              ...
              <div className="feature-card-desc">
                Information may be shared with MotoBites to facilitate order
                fulfilment, delivery operations, customer support and service
                management.
              </div>
            </div>
            ...
            <div className="feature-card">
              ...
              <div className="feature-card-desc">
                Customers may receive limited information necessary to
                facilitate delivery, such as the Rider&rsquo;s first name,
                vehicle information or delivery status, where applicable.
              </div>
            </div>
            ...
            <div className="feature-card">
              ...
              <div className="feature-card-desc">
                Relevant information may be shared with merchants to facilitate
            ...
            <div className="feature-card">
              ...
              <div className="feature-card-desc">
                Third-party providers for cloud hosting, GPS/location services,
                identity verification, communication, analytics, payment
                processing, customer support, and security.
              </div>
            </div>
          </div>
          <p style={{ marginTop: "1.25rem" }}>
            <strong>Government and Regulatory Authorities:</strong> We may
            disclose information where required by applicable law, regulation,
            court order or lawful governmental request.
          </p>
        </>
      ),
    },
      ...
      content: (
        <>
          ...
          <p>
            ...
            encryption where appropriate, monitoring and other safeguards.
          </p>
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p>
            You may be able to opt out of certain promotional communications
            through the available unsubscribe or communication preference
            mechanisms.
          </p>
          <p>
            Operational and service-related communications may still be sent
            where necessary.
          </p>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          <p>
            MotoRide and its service providers may use cookies, SDKs, analytics
            technologies or similar mechanisms where applicable.
          </p>
          ...
          <p>
            The technologies used may vary depending on the version and
            architecture of the MotoRide platform.
          </p>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          <p>
            MotoRide is intended for individuals who are legally eligible to
            perform delivery services.
          </p>
          <p>
            We do not knowingly collect personal information from individuals
            who are not eligible to use the platform.
          </p>
          <p>
            If we become aware that personal information has been collected from
            an ineligible individual, we may take appropriate steps to delete
            it.
          </p>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          <p>
            MotoRide may integrate with third-party services. These services may
            have their own privacy policies and terms.
          </p>
          <p>
            MotoRide is not responsible for the independent privacy practices of
            third-party services that are outside our control.
          </p>
          <p>
            Users should review the privacy policies of relevant third-party
    ...
    },
    {
      ...
      content: (
        <>
          <p>
            Some technology or service providers used by MotoRide may process
            information outside Nigeria or outside the country where you
            operate.
          </p>
          <p>
            Where applicable, we will take reasonable steps to ensure that
            personal information is processed in accordance with applicable data
      ...
      content: (
        <>
          <div className="document-intro-banner">
            ...
            <div className="banner-text">
              <strong>NDPA Compliance:</strong> Where applicable, MotoRide will
              process personal information in accordance with relevant Nigerian
              data protection requirements, including the{" "}
      ...
      content: (
        <>
          ...
          <p>
            ...
            MotoRide application, email, website or other appropriate
            communication channels.
          </p>
          <p>
            The updated Privacy Policy will include a revised &ldquo;Last
            Updated&rdquo; date.
          </p>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          <p>
            If you have questions, concerns or requests relating to your
    ...
    },
    {
      ...
      content: (
        <>
          <p>
            By using MotoRide, you acknowledge that you have had the opportunity
            to review this Privacy Policy and understand how your personal
            information may be processed in connection with the MotoRide
            platform.
          </p>
        </>
      ),
  ...
  const termsSections: PolicySection[] = [
    {
      ...
      content: (
        <>
          <p>
            MotoRide is a technology platform used to coordinate delivery
            activities for MotoBites.
          </p>
          <p>
            The platform enables approved Riders and Delivery Partners to
            receive, manage and complete delivery assignments.
          </p>
          <p>
            MotoRide is not limited to motorcycles. Depending on operational
            requirements, approved delivery vehicles may include:
          </p>
          <ul className="styled-list">
            <li>Motorcycles;</li>
            <li>Cars;</li>
          ...
          <p>
            These Terms apply to every individual or entity authorised to use
            MotoRide for delivery purposes.
          </p>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          <p>
            By registering for, accessing or using MotoRide, you agree to comply
            with these Terms &amp; Conditions.
          </p>
          <p>
            If you do not agree with these Terms, you should not use the
            MotoRide application.
          </p>
          <p>
            MotoRide may update these Terms from time to time in accordance with
            Section 26.
          </p>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          ...
          <p>
            MotoRide may reject or suspend an application where eligibility
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p>
            You must notify MotoRide promptly if you believe your account has
            been compromised.
          </p>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          ...
          <p>
            MotoRide may request evidence of vehicle documentation or conduct
            verification before or during your participation on the platform.
          </p>
          <p>
            MotoRide may restrict particular vehicle types from certain delivery
            assignments based on order characteristics, location, safety or
    ...
    },
    {
      ...
      content: (
        <>
          <p>
            MotoRide may offer delivery assignments based on factors such as:
          </p>
          <ul className="styled-list">
          ...
          <p>
            Assignments may be communicated through the application. Riders are
            responsible for reviewing assignment information before accepting a
            delivery.
          </p>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          <p>
            When a Rider accepts a delivery assignment, the Rider is expected to
            make reasonable efforts to complete it.
          </p>
          <p>
            If an unexpected situation prevents completion, the Rider must
            notify MotoRide through the appropriate support or cancellation
            process as soon as reasonably possible.
          </p>
          <p>Repeated unjustified cancellations may affect account status.</p>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          ...
          >
            ...
            <div className="banner-text">
              <strong>Order Integrity Mandate:</strong> Riders must not
              intentionally interfere with, consume, open or tamper with
              customer orders.
            </div>
          </div>
        </>
      ...
      content: (
        <>
          ...
          <ul className="styled-list">
            ...
            <li>
              Complete delivery confirmation through the approved process.
            </li>
          </ul>
    ...
    },
    {
      ...
      content: (
        <>
          <p>
            If a customer cannot be reached, the Rider must follow the MotoRide
            failed-delivery procedure. This may include:
          </p>
          <ul className="styled-list">
          ...
          <p>
            Riders must not independently dispose of, retain or falsely mark an
            undelivered order without following the applicable procedure.
          </p>
        </>
      ),
    },
      ...
      content: (
        <>
          ...
          <ul className="styled-list">
            ...
            <li>
              Other circumstances beyond the Rider&rsquo;s reasonable control.
            </li>
          </ul>
          <p>Riders must report significant delays where appropriate.</p>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          ...
          <ul className="styled-list">
            ...
            <li>
              Stop driving if continuing would create an unreasonable safety
              risk.
            </li>
          </ul>
          <div
          ...
          >
            ...
            <div className="banner-text">
              <strong>Core MotoRide Principle:</strong> No delivery target,
              incentive or payment justifies unsafe behaviour.
            </div>
          </div>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          <p>
            Riders must behave professionally when interacting with customers,
            merchants, employees and other delivery partners.
          </p>
    ...
    },
    {
      ...
      content: (
        <>
          <p>
            Where cash collection is enabled, Riders must collect only the
            amount displayed or authorised through MotoRide.
          </p>
          <p>Riders must not:</p>
          <ul className="styled-list">
          ...
          <p>
            Any collected funds must be handled and remitted according to
            MotoRide&rsquo;s applicable procedures.
          </p>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          ...
          <p>
            The applicable payment structure will be communicated through the
            Rider platform or relevant agreement.
          </p>
          <p>
            MotoRide may introduce, modify or discontinue incentives subject to
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p>
            Performance information may be used for operational improvement,
            training, fraud prevention and account management.
          </p>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          <p>
            Customers, merchants and MotoRide may provide ratings or feedback
          ...
          <p>
            Riders may be given an opportunity to respond to relevant complaints
            where appropriate.
          </p>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          ...
          <p>
            <strong>Emergency Assistance:</strong> In an emergency, Riders
            should contact appropriate emergency services where necessary.
          </p>
        </>
      ),
    },
    ...
    },
    {
      ...
      content: (
        <>
          <p>
            MotoRide may work with third-party fleet operators, logistics
            companies and other delivery service providers.
          </p>
          <p>
            Riders operating through such organisations may be subject to
            additional contractual requirements.
          </p>
          <p>
            However, use of MotoRide remains subject to applicable MotoRide
            platform, safety and conduct requirements.
          </p>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          <p>
            Riders are responsible for maintaining all licences, permits,
            registrations and insurance required by applicable law or their
            specific engagement arrangement.
          </p>
          <p>
            Unless expressly provided under a separate written agreement, Riders
            should not assume that MotoRide provides personal accident, vehicle,
            health or third-party liability insurance.
          </p>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          <p>
            MotoRide and its licensors retain ownership of the MotoRide
            application, software, trademarks, designs, content and other
            intellectual property.
          </p>
          <p>
            You may use the application only for authorised purposes. You must
            not:
          </p>
          <ul className="styled-list">
    ...
    },
    {
      ...
      content: (
        <>
          <p>
            MotoRide may suspend an account where there is a reasonable basis to
            believe that a Rider:
          </p>
          <ul className="styled-list">
          ...
          <p>
            Serious safety, fraud or security issues may result in immediate
            suspension while an investigation takes place.
          </p>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          <p>
            MotoRide may terminate access where appropriate, subject to
            applicable law and any separate contractual arrangement.
          </p>
          <p>
            Where appropriate, Riders may be informed of the reason for
            termination and available review or appeal procedures.
          </p>
          <p>
            Termination does not remove obligations that are intended to survive
            termination.
          </p>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          <p>
            If you believe an account action, payment issue or delivery-related
            decision is incorrect, you may contact MotoRide Support.
          </p>
          ...
          <p>
            MotoRide may investigate the matter and communicate the outcome
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p>
            Where appropriate, material changes will be communicated through the
            MotoRide application, email or other appropriate channels.
          </p>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          <p>
            MotoRide aims to maintain reliable access to the application but
            does not guarantee uninterrupted availability. Access may be
    ...
    },
    {
      ...
      content: (
        <>
          <p>
            To the maximum extent permitted by applicable law, MotoRide shall
            not be responsible for losses arising from circumstances outside its
            reasonable control.
          </p>
          <p>
    ...
    },
    {
      ...
      content: (
        <>
          <p>
            MotoRide shall not be responsible for failure or delay caused by
            circumstances beyond its reasonable control, including natural
            disasters, government actions, civil unrest, infrastructure
            failures, widespread network outages or other extraordinary events.
          </p>
        </>
      ),
    },
      ...
      content: (
        <>
          <div className="document-intro-banner">
            ...
            <div className="banner-text">
              <strong>Jurisdiction:</strong> These Terms shall be governed by
              the laws applicable in the jurisdiction where MotoRide operates.
              For operations in Nigeria, applicable Nigerian laws and
    ...
    },
    {
      ...
      content: (
        <>
          <p>
            MotoRide encourages Riders to first attempt to resolve disputes
            through the designated MotoRide support process.
          </p>
          <p>
            Where a dispute cannot be resolved through internal procedures, the
            parties may pursue any remedies available under applicable law.
          </p>
        </>
      ),
    },
      ...
      content: (
        <>
          ...
          <ul className="styled-list">
            ...
            <li>
              I understand that violations may result in suspension or
              termination.
            </li>
          </ul>
  ...
  const currentSections =
    activeTab === "privacy" ? privacySections : termsSections;
    ...
    <div className="page-container">
      ...
      <header className="navbar">
        <div className="navbar-inner">
          ...
          <ul className="nav-links">
            <li>
              <a href="#privacy-information-we-collect">Collected Data</a>
            </li>
            <li>
              <a href="#privacy-location-information">Location &amp; GPS</a>
            </li>
            <li>
              <a href="#privacy-information-sharing">MotoBites Network</a>
            </li>
            <li>
              <a href="#privacy-nigeria-ndpa">NDPA Compliance</a>
            </li>
            <li>
              <a href="#privacy-contact-us">Support</a>
            </li>
          </ul>
      ...
      <section className="hero-section">
        <div className="hero-content">
          ...
          <div
            className="pill-switcher-container"
            role="tablist"
            aria-label="Legal Documents Switcher"
          >
            <button
              role="tab"
          ...
          <article className="document-container">
            {activeTab === "privacy" ? (
              ...
              >
                ...
                >
                  <div>
                    <strong>Operated by:</strong> MotoBites Limited
                  </div>
                  <div>&bull;</div>
                  <div>
                    <strong>Platform:</strong> MotoRide
                  </div>
                  <div>&bull;</div>
                  <div>
                    <strong>Related Platform:</strong> MotoBites
                  </div>
                  <div>&bull;</div>
                  <div>
                    <strong>Effective:</strong> September 2026
                  </div>
                </div>
              </div>
            ) : (
              ...
              >
                ...
                >
                  <span className="policy-badge orange">
                ...
                >
                  ...
                  <div>&bull;</div>
                  <div>
                    <strong>Fleet:</strong> Motorcycles, Cars, Vans,
                    Three-Wheelers &amp; Bicycles
                  </div>
                  <div>&bull;</div>
                  <div>
                    <strong>Effective:</strong> September 2026
            ...
            {filteredSections.length === 0 ? (
              <div className="no-results">
                ...
                <p>
                  We couldn&rsquo;t find any clauses matching &ldquo;
                  {searchQuery}&rdquo;.
                </p>
                <button
        ...
        <div className="footer-inner">
          <div className="footer-top">
            <div className="footer-brand">
              ...
              <p>
                MotoRide is operated by MotoBites Limited to coordinate delivery
                services for MotoBites and other authorised delivery operations.
              </p>
            </div>
            ...
            <div className="footer-columns">
              <div>
                ...
                <ul className="footer-col-links">
                  ...
                  <li>
                    <a href="#privacy-nigeria-ndpa">NDPA 2023 Compliance</a>
                  </li>
                  <li>
                    <a href="#privacy-location-information">
              ...
              <div>
                ...
                <ul className="footer-col-links">
                  <li>
                    <a href="#">MotoRide Rider App</a>
                  </li>
                  <li>
                    <a href="#">MotoBites Delivery</a>
                  </li>
                  <li>
                    <a href="#">Fleet &amp; Partner Onboarding</a>
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="footer-col-links">
                  <li>
                    <a href="#privacy-contact-us">Privacy Team</a>
                  </li>
                  <li>
                    <a href="#terms-contact-info">Rider Support</a>
                  </li>
                  <li>
                    <a href="#terms-appeals-complaints">
                      Appeals &amp; Complaints
                    </a>
                  </li>
                </ul>
          ...
          <div className="footer-bottom">
            <div>
              &copy; 2026 MotoBites Limited. All rights reserved. Platform:
              MotoRide.
            </div>
